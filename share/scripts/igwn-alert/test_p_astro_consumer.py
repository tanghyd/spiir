...
@click.argument("signal-config", type=click.Path(exists=True), description="Path to fgmc.pkl model file.")
@click.argument("source-config", type=click.Path(exists=True), description="Path to mchirp_area.pkl model file.")
